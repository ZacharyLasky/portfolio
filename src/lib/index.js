...
export const missionContent = {
  text: {
    ...
    second:
      "Most of the time, I write front end code using React and TypeScript.",
    third:
      "On the back end, I will most often write code using Node with Express."
  },
...
export const purposeContent = {
  text: {
    ...
    third:
      "Now I've been worked in Boston, MA as a software engineer for a startup, Talla and currently for a much larger company, Healthgrades."
  },
...
export const promiseContent = {
  text: {
    ...
    second:
      "I'm also available for consulting or mentoring other who want to get into my field.",
